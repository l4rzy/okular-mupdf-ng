...
///    Unsaved form and annotation changes are discarded after a warning;
...
private:
    ...
    // Unsaved form and annotation changes are discarded on worker recovery;
    // annotations are rebuilt from the clean reopened source document.
