...
#ifndef MU_GENERATOR_CONFIG_CERTMANAGER_MANAGER_DIALOG_HPP
#define MU_GENERATOR_CONFIG_CERTMANAGER_MANAGER_DIALOG_HPP
...
#endif // MU_GENERATOR_CONFIG_CERTMANAGER_MANAGER_DIALOG_HPP
